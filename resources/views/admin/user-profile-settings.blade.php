									...
									<div class="col ml-md-n2 profile-user-info">
										...
										<div class="social">
                                          ...
                                          <ul style="list-style;none; width: 400px; font-size:30px;" class="d-flex flex-row justify-content-between">
											...
											<li><a href=""><i class="fe fe-facebook" aria-hidden="true"></i></a></li>
												@endif
											...
											@endif
											@if($social != NULL AND isset($social ->linkd))
															...
															<form action="{{ route('user.profile.update')}}" method="POST" enctype="multipart/form-data">
																...
																<div class="row form-row">
																	...
																	<div class="col-12">
																		<div class="form-group">
																		<label>Twitter</label>
																			<input name="tw" type="text" value="@if($social !=NULL){{$social-> tw}} @endif" class="form-control">
																		</div>
																	</div>
																	<div class="col-12">
																		<div class="form-group">
																		<label>Pinterest</label>
																			<input name="linkd" type="text" value="@if($social !=NULL){{$social-> linkd}} @endif" class="form-control">
																		</div>
																	</div>
																	<div class="col-12">
																		<div class="form-group">
																		<label>Instagram</label>
																			<input name="insta" type="text" value="@if($social !=NULL){{$social-> insta}} @endif" class="form-control">
																		</div>
																	</div>
																	<div class="col-12">
																		<div class="form-group">
